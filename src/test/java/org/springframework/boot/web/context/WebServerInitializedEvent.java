 ...
 * references the old package path via SimpleDiscoveryClientAutoConfiguration
 * and SimpleReactiveDiscoveryClientAutoConfiguration. This stub allows class
 * loading to succeed so Spring Cloud conditions can evaluate properly.
 */
