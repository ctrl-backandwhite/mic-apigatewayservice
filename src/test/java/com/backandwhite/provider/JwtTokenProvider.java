...
public final class JwtTokenProvider {
    ...
    public static String customerToken(String email) {
        return JwtUtils.generateToken(email, List.of(AppConstants.ROLE_CUSTOMER),
                TEST_SECRET, EXPIRATION_MS, TEST_ISSUER);
    }

    public static String adminToken(String email) {
        return JwtUtils.generateToken(email, List.of(AppConstants.ROLE_ADMIN),
                TEST_SECRET, EXPIRATION_MS, TEST_ISSUER);
    }

    public static String expiredToken(String email) {
        return JwtUtils.generateToken(email, List.of(AppConstants.ROLE_CUSTOMER),
                TEST_SECRET, -1000L, TEST_ISSUER);
    }
}
